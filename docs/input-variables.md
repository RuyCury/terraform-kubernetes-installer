...
master_ol_image_name                | Oracle-Linux-7.7-2019.11.12-0  | Image name of an Oracle-Linux-7.X image to use for masters
worker_ol_image_name                | Oracle-Linux-7.7-2019.11.12-0  | Image name of an Oracle-Linux-7.X image to use for workers
etcd_ol_image_name                  | Oracle-Linux-7.7-2019.11.12-0  | Image name of an Oracle-Linux-7.X image to use for etcd nodes
nat_ol_image_name                   | Oracle-Linux-7.7-2019.11.12-0  | Image name of an Oracle-Linux-7.X image to use for NAT instances (if applicable)
