output "master_instance_ids" {
  value = concat(
    module.instances-k8smaster-ad1.ids,
    module.instances-k8smaster-ad2.ids,
    module.instances-k8smaster-ad3.ids,
  )
}

output "worker_instance_ids" {
  value = concat(
    module.instances-k8sworker-ad1.ids,
    module.instances-k8sworker-ad2.ids,
    module.instances-k8sworker-ad3.ids,
  )
}
...
output "etcd_public_ips" {
  value = compact(
    concat(
      module.instances-etcd-ad1.instance_public_ips,
      module.instances-etcd-ad2.instance_public_ips,
      module.instances-etcd-ad3.instance_public_ips,
    ),
  )
}
...
output "worker_public_ips" {
  value = flatten(
    concat(
      module.instances-k8sworker-ad1.public_ips,
      module.instances-k8sworker-ad2.public_ips,
      module.instances-k8sworker-ad3.public_ips,
    ),
  )
}
...
output "worker_private_ips" {
  value = concat(
    module.instances-k8sworker-ad1.private_ips,
    module.instances-k8sworker-ad2.private_ips,
    module.instances-k8sworker-ad3.private_ips,
  )
}
...
output "nat_instance_public_ips" {
  value = compact(
    concat(
      module.vcn.nat_instance_ad1_public_ips,
      module.vcn.nat_instance_ad2_public_ips,
      module.vcn.nat_instance_ad3_public_ips,
    ),
  )
}
...
output "nat_instance_private_ips" {
  value = compact(
    concat(
      module.vcn.nat_instance_ad1_private_ips,
      module.vcn.nat_instance_ad2_private_ips,
      module.vcn.nat_instance_ad3_private_ips,
    ),
  )
}
